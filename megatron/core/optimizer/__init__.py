...
from .emerging_optimizers import (
    ...
    get_emerging_optimizer_param_overrides,
)
...
# Optimizer-specific config subclasses are retained for API compatibility.
...
def _get_megatron_emerging_optimizer(
    ...
    config_overrides.update(get_emerging_optimizer_param_overrides(eopt_name, config))
