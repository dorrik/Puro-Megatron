...
`run_brief_0p6b.sh` is the recipe. Cluster scripts live in `../puro/alliance/`, the corpus
pipeline in `../puro/data/`. The budget and phased plan are on the Brief Frontier Budget page.
